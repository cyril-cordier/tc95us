<template>
  <div class="Admin">
      ...
      <router-link to="/MonCompte" class="dropdown-item">Accéder à mon Compte</router-link>
    ...
    <h1>Admin</h1>
    <p>Connecté en tant que {{user.firstname}} {{user.lastname}} - statut admin : {{user.admin}}</p>
