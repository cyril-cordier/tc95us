  ...
  <div class="rencontres">
    <div class="container-fluid">
      <div class="row row-cols-1 row-cols-md-2">
        <div class="col 9">
          <h1>Championnats par Equipes</h1>

          <p>Vous trouverez ici les résultats des rencontres par équipes du TC Us</p>
        ...
        <div class="col 3">
          <div class="card">
            ...
            <h1>Le mot du Responsable des Equipes</h1>
            <br><br><br>
            <div v-for="content in getAllContents" :key="content.id">
              <div v-if="content.title == 'Le mot du Responsable Equipes (page Championnats)'">
